      ...
      <div className="flex flex-col items-center gap-14 py-12 sm:py-24 z-10">
        <div className="text-center flex flex-col items-center">
          ...
          <div className="relative flex flex-col items-center text-center pt-8">
            ...
            <h1 className="sm:text-[45px] font-bold sm:leading-normal text-[40px] leading-[47px] uppercase pt-4 sm:pt-0 text-white mask-text tracking-[3px] gradient-text text-transparent animate-gradient">
              test your strength
            </h1>
